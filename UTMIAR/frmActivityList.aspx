...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyContent" Runat="Server">
    ...
    <ul style="font-size: small">
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/UTMIAR/frmActivityDetails.aspx" Font-Bold="True"><i class="fa fa-caret-right fa-lg" style="color:maroon"></i>&nbsp;01/03/2017</asp:HyperLink>
    </ul>
</asp:Content>
