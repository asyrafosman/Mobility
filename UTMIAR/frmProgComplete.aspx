<%@ Page Title="ACAD2016." Language="C#" MasterPageFile="~/UTMIAR/UTMIARMasterPage.master" AutoEventWireup="true" CodeFile="frmProgComplete.aspx.cs" Inherits="UTMIAR_frmProgComplete" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyContent" Runat="Server">
    ...
    <br /><br />
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MOBILITY.XE %>" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT * FROM &quot;PROG_COMPLETE&quot;" ProviderName="<%$ ConnectionStrings:MOBILITY.XE.ProviderName %>">
    </asp:SqlDataSource>
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" CellPadding="4" DataSourceID="SqlDataSource1" EmptyDataText="No record found" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" Width="100%">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Status" SortExpression="PROG_STATUS">
                <ItemTemplate>
                    <asp:Label ID="Status" runat="server" Text='<%# Eval("PROG_STATUS").ToString() == "3" ? "Completed" : "Submitted" %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:MOBILITY.XE %>" ProviderName="<%$ ConnectionStrings:MOBILITY.XE.ProviderName %>" SelectCommand="SELECT * FROM &quot;PROG_COMPLETE&quot; WHERE (&quot;PROG_PROGNAME&quot; LIKE '%' + ? + '%')">
        <SelectParameters>
