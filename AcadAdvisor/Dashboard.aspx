<%@ Page Title="ACAD2016." Language="C#" MasterPageFile="~/AcadAdvisor/AAMasterPage.master" AutoEventWireup="true" CodeFile="Dashboard.aspx.cs" Inherits="AcadAdvisor_Dashboard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyContent" Runat="Server">
    ...
    <br />
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MOBILITY.XE %>" SelectCommand="SELECT * FROM &quot;INBOX_SV&quot;" ProviderName="<%$ ConnectionStrings:MOBILITY.XE.ProviderName %>">
    </asp:SqlDataSource>
