<%@ Page Title="ACAD2016." Language="C#" MasterPageFile="~/UTMID/UTMIDMasterPage.master" AutoEventWireup="true" CodeFile="frmActivityList.aspx.cs" Inherits="UTMID_frmActivityList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyContent" Runat="Server">
    ...
    <ul style="font-size: small">
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/UTMID/frmActivityDetails.aspx" Font-Bold="True"><i class="fa fa-caret-right fa-lg" style="color:maroon"></i>&nbsp;01/03/2017</asp:HyperLink>
    </ul>
</asp:Content>
