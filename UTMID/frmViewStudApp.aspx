<%@ Page Title="ACAD2016." Language="C#" MasterPageFile="~/UTMID/UTMIDMasterPage.master" AutoEventWireup="true" CodeFile="frmViewStudApp.aspx.cs" Inherits="UTMID_frmViewStudApp" %>
    ...
    <div class="name-bgcolor">
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/TNCAA/frmViewForm.aspx" Font-Bold="True" onclick="window.open (this.href, 'popupwindow', 'width=1300,height=700, scrollbars, resizable'); return false;"><i class="fa fa-file-text fa-lg" style="color:maroon"></i>&nbsp;View Full Application Form</asp:HyperLink>
            </div>
        </div>
        <div class="statfiller">
        </div>
